...
<%
ArrayList<CommentairesBean> commentaires = (ArrayList) request.getAttribute("commentaires");
%>
<!DOCTYPE html>
<html lang="fr">
                ...
                <div class="col-xl-12">
                    <div class="cart-table table-responsive">
                        <table id="clicFavoris-search" class="display"> <!-- table table-bordered text-center -->
                            ...
                            <%
                            for ( CommentairesBean p : commentaires ) {
                            %>
                                <tr>
                                    <%-- <td>
                                        <div class="cart-img">
                                    ...
                                    <td>
                                        <div class="cart-edit">
                                            ...
                                            <a class="btn btn-primary btn-block" 
                                            	href="Produit_Card?id=<%= p.getFk_prod() %>">
                                            	<i class="fa-solid fa-eye"></i></i>
                                            </a>
                                            <a class="btn btn-danger btn-block" 
                                            	href="UtilisateursPageCommentaire?idCommentaire=<%= p.getId() %>">
